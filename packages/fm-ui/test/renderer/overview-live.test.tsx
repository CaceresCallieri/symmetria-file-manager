...
it("refreshes only a changed loaded branch and releases overview watches on close", async () => {
  ...
  // The hidden Miller preview can show the new file before the overview refreshes.
  // Scope this wait to the overview so the assertion measures its branch read.
